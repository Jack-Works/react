...
function finishClassComponent(
  ...
  if (
    ...
    if (__DEV__) {
      setIsRendering(true);
      nextChildren = __DEV__ && workInProgress._debugStack ? workInProgress._debugStack.run(() => instance.render()) : instance.render();
      if (
        debugRenderPhaseSideEffectsForStrictMode &&
        ...
        try {
          __DEV__ && workInProgress._debugStack ? workInProgress._debugStack.run(() => instance.render()) : instance.render();
        } finally {
