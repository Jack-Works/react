    ...
    do {
      if ((effect.tag & flags) === flags) {
        ...
        if (destroy !== undefined) {
          ...
          safelyCallDestroy(finishedWork, nearestMountedAncestor, destroy, effect.stack);
          if (__DEV__) {
            if ((flags & HookInsertion) !== NoHookEffect) {
  ...
  if (lastEffect !== null) {
    ...
    do {
      if ((effect.tag & flags) === flags) {
        ...
        if (__DEV__ && effect.stack) {
          effect.destroy = effect.stack.run(create);
        } else {
      ...
      if (!offscreenSubtreeWasHidden) {
        ...
        if (updateQueue !== null) {
          ...
          if (lastEffect !== null) {
            ...
            let effect = firstEffect;
            do {
              const {destroy, tag, stack} = effect;
              if (destroy !== undefined) {
